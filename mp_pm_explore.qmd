...
q_flighthistory <- "SELECT *
                    FROM CT_FLIGHT_HISTORY WHERE FLIGHT_DATE BETWEEN '2019-01-01' AND '2024-09-23';"
...
q_flightleg <- "SELECT *
                FROM CT_FLIGHT_LEG WHERE PAIRING_DATE BETWEEN '2018-12-25' AND '2024-09-23';"
...
q_masterpairing <- "SELECT *
                    FROM CT_MASTER_PAIRING WHERE PAIRING_DATE BETWEEN '2018-12-25' AND '2024-09-23';"
